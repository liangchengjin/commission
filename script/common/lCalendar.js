        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>' +
                    '<div style="float: left"></div><div class="btn-top line-border"></div></div>' +
            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    if (!isNaN(top)) {
                        top % 3 == 0 ? (top = top) : (top = top + 1);
                        top > 9 && (top = 9);
                        var minTop = 9 - (passY - 1) * 3;
                        top < minTop && (top = minTop);
                        date_yy.style["-webkit-transform"] = 'translate3d(0,' + top + 'em,0)';
                        date_yy.setAttribute('top', top + 'em');
                        yyVal = Math.abs(top - 9) / 3;
                        date_yy.setAttribute("val", yyVal);
                    } else {
                        date_yy.style["-webkit-transform"] = 'translate3d(0,' + (9 - yyVal * 3) + 'em,0)';
                        date_yy.setAttribute('top', 9 - yyVal * 3 + 'em');
                    }
                } else {
                    return;
                }
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    date_mm.style["-webkit-transform"] = 'translate3d(0,' + (9 - (mmVal - minM) * 3) + 'em,0)';
                    date_mm.setAttribute('top', 9 - (mmVal - minM) * 3 + 'em');
                } else {
                    return;
                }
            ...
            function setTimeGearTooth() {
                ...
                if (time_hh && time_hh.getAttribute("val")) {
                    ...
                    time_hh.innerHTML = i;
                    time_hh.style["-webkit-transform"] = 'translate3d(0,' + (9 - hhVal * 3) + 'em,0)';
                    time_hh.setAttribute('top', 9 - hhVal * 3 + 'em');
                } else {
                    return
                }
                var time_mm = _self.gearDate.querySelector(".time_mm");
                if (time_mm && time_mm.getAttribute("val")) {
                    ...
                    time_mm.innerHTML = i;
                    time_mm.style["-webkit-transform"] = 'translate3d(0,' + (9 - mmVal * 3) + 'em,0)';
                    time_mm.setAttribute('top', 9 - mmVal * 3 + 'em');
                } else {
                    return
                }
                ...
                if (time_ss && time_ss.getAttribute("val")) {
                    ...
                    time_ss.innerHTML = i;
                    time_ss.style["-webkit-transform"] = 'translate3d(0,' + (9 - mmVal * 3) + 'em,0)';
                    time_ss.setAttribute('top', 9 - mmVal * 3 + 'em');
                } else {
                    return
                }
            }
                ...
                target["int_" + target.id] = setInterval(function() {
                    ...
                    switch (target.dataset.datetype) {
                        ...
                        case "date_mm":
                            ...
                            var minTop = 9 - (maxM - minM) * 3;
                            if (pos < minTop) {
                                pos = minTop;
                                stopGear = true;
                            }
                            if (stopGear) {
                                var gearVal = Math.abs(pos - 9) / 3 + minM;
                                setGear(target, gearVal);
                                clearInterval(target["int_" + target.id]);
                            }
                            break;
                        case "date_dd":
                            ...
                            var minTop = 9 - (maxD - minD) * 3;
                            if (pos < minTop) {
                                pos = minTop;
                                stopGear = true;
                            }
                            if (stopGear) {
                                var gearVal = Math.abs(pos - 9) / 3 + minD;
                                setGear(target, gearVal);
                                clearInterval(target["int_" + target.id]);
                            }
                            break;
